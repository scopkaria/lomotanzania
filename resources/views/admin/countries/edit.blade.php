<x-app-layout>
    <x-slot name="header">Edit: {{ $country->name }}</x-slot>

    <div class="mb-4 flex items-center justify-between">
        <a href="{{ route('admin.countries.index') }}" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700">
