<x-app-layout>
    ...
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('admin.workers.admin-store') }}" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
            @csrf
            ...
            <div class="flex justify-end gap-3 pt-3 border-t border-gray-100">
                ...
                <button type="submit" class="px-5 py-2.5 bg-brand-green text-white rounded-xl text-sm font-medium hover:bg-brand-green/90 transition">Create Administrator</button>
            </div>
        </form>
    </div>
</x-app-layout>
