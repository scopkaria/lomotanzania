<x-app-layout>
    ...
    <div class="mb-4 flex items-center justify-between">
        ...
        <a href="{{ route('tour-types.show', ['slug' => $tourType->slug]) }}" target="_blank" class="inline-flex items-center gap-1.5 px-4 py-2 bg-brand-green text-white text-xs font-semibold rounded-lg hover:bg-green-800 transition shadow-sm">
