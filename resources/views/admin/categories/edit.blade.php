<x-app-layout>
    <x-slot name="header">Edit: {{ $category->name }}</x-slot>
    ...
    <div class="mb-4 flex items-center justify-between">
        ...
        <a href="{{ route('categories.show', ['locale' => app()->getLocale(), 'slug' => $category->slug]) }}" target="_blank" class="inline-flex items-center gap-1.5 px-4 py-2 bg-brand-green text-white text-xs font-semibold rounded-lg hover:bg-green-800 transition shadow-sm">
