        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" type="button" class="flex items-center gap-1.5 text-sm text-gray-500 border border-gray-200 rounded-lg px-3 py-2 hover:bg-gray-50">
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-30">
            ...
            <table class="min-w-full divide-y divide-gray-100 admin-table">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($safaris as $safari)
                        ...
                        @endphp
                        <tr class="hover:bg-[#F9F7F3]/60 transition-colors" :class="isSelected({{ $safari->id }}) && 'bg-[#083321]/5'">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    @endif
                                    <div class="min-w-0">
                                        <p class="text-sm font-semibold text-gray-900 truncate">{{ $safari->title }}</p>
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('safaris.show', $safari->slug) }}" target="_blank" class="text-gray-400 hover:text-[#083321] transition" title="View on site">
