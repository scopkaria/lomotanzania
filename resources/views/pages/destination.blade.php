    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div class="lg:col-span-3">
                ...
                @else
                    <p class="text-brand-dark/90 italic">"”</p>
                @endif
                ...
                @if($destination->latitude && $destination->longitude)
                    <div class="mt-8 flex flex-wrap gap-6">
                        <div class="flex items-center gap-2 text-sm text-brand-dark/80">
                            ...
                            {{ number_format($destination->latitude, 4) }}Â°, {{ number_format($destination->longitude, 4) }}Â°
                        </div>
                        @if($destination->country)
                            <div class="flex items-center gap-2 text-sm text-brand-dark/80">
...
<section class="py-16 md:py-24 bg-brand-light">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <p class="text-brand-dark/90 text-sm">{{ __('messages.no_safaris_destination') }}</p>
    </div>
</section>
@endif
